...
const SignupForm = ({backHandler,setUserform,userForm,submitHandler}) => {
  return (
    <div className='border-2 p-5 flex-col justify-center items-center rounded-lg w-1/4 border-cyan-500'>
        ...
        <form className='flex-col flex gap-6' onSubmit={submitHandler} >
            <div className='flex flex-col'>
                ...
                <input type="text" id='fullname' className='border-2' onChange={(e)=>setUserform({...userForm,fullname:e.target.value})}/>
            </div>
            <div className='flex flex-col'>
            ...
            <button className='w-full border-[1px] rounded-md bg-cyan-500 py-2 text-white'>Submit</button>
        </form>
